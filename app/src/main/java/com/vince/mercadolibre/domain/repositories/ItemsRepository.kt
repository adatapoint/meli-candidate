...
interface ItemsRepository {
    ...
    suspend fun getItems(query: String): CallResult<ItemsWithPagination<Item>>

    suspend fun getItemsByCategory(categoryId: String): CallResult<ItemsWithPagination<Item>>
